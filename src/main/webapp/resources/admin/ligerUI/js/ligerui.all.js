...
(function ($)
{
    ...
    $.ligerui.win = {
        ...
        mask: function (win)
        {
        	var zIndex = window.top.zIndex + 1;
        	window.top.zIndex = zIndex;
            ...
            this.windowMask = $("<div maskid=M_"+win.id+" class='l-window-mask' style='display: block;z-index:"+zIndex+";'></div>").appendTo('body');
        ...
        unmask: function (win)
        {
            $("body>div[maskid='M_"+win.id+"']").remove();
        },
        ...
        setFront: function (win)
        {
            ...
            for (var i in wins)
            {
                ...
                if (w == win)
                {
                	if($(w.element).css("z-index") == 10000){
                		var zIndex = window.top.zIndex + 1;
      				window.top.zIndex = zIndex;
        				win.zindex = zIndex;
                   	$(w.element).css("z-index", zIndex);
                    }
                    this.activeTask(w);
                }
                else
...
(function ($)
{
    ...
    l.controls.Dialog.ligerExtend(l.core.Win, {
        ...
        {
            var g = this;
            if(g.options.url && $.isFunction(g.options.onClose)){
            	g.options.onClose();
            }
